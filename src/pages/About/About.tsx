              ...
              <Col xs={24} md={8} className="flex flex-col h-full">
                ...
                <Row className="flex-1 flex flex-col justify-start mt-5">
                  <Text className="text-md font-normal text-black font-sans text-justify">
                    Shin pursued higher education at the University of Southern
                    California, obtaining a B.A. in Business Administration, an
                    MBA, and a Juris Doctorate in Law. During his college years,
                    he ventured into business by starting a valet parking
                    service and engaging in real estate sales. Post-graduation,
                    he briefly worked with Coca-Cola in an entry-level
                    management role before transitioning to the financial
                    services sector.
                  </Text>
                </Row>
              ...
              <Col xs={24} md={8} className="flex flex-col h-full">
                ...
                <Row className="flex-1 flex flex-col justify-start mt-5">
                  <Text className="text-md font-normal text-black font-sans text-justify">
                    ...
                    million-dollar enterprises and is the Co-Founder of the ALL
                    FOR ONE Foundation and sits on over 6 different boards of
                    charities.
                  </Text>
                </Row>
              </Col>
              <Col xs={24} md={8} className="flex flex-col">
                <Row gutter={[0, 16]} className="w-full">
                  <Col xs={24} md={16} order={1}>
                    <Text className="text-md font-normal text-black font-sans text-justify">
                      ...
                      film, "Think and Grow Rich: The Legacy," which is sweeping
                      the world in multiple countries and the modern-day author
                      of the bestselling book, Think and Grow Rich, written by
                      Napoleon Hill in 1937. His book, A Think and Grow Rich
                      Publication, was released on January 6th, 2020 called "HOW
                      RICH ASIANS THINK AND GROW RICH," published by the
                ...
                <Row className="flex-1 flex flex-col justify-start mt-5">
                  <Text className="text-md font-normal text-black font-sans text-justify">
                    ...
                    John Shin received his B.S. in Business Administration from
                    the University of Southern California, an M.B.A., and a
                    Juris Doctorate Degree in Law. Immediately after college,
                    John was recruited to work at a Fortune 100 company but soon
                    learned that the corporate world was not for him. <br />
                    John Shin was introduced to the financial services industry
                    by his wife, Arlene, in 1994 and since then they have opened
                    over 128 offices in 42 different states.
                    ...
                    thousands of people nationwide to become successful business
                    owners. In John Shin’s own words, he says, “Show me your
                    mentor, and I’ll show you your future.”
